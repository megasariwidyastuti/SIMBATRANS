...
lyr_GoogleHybrid_0.setVisible(true);lyr_52KawasanTransmigrasiPronas_1.setVisible(true);lyr_JenisTanahFAO_2.setVisible(true);lyr_PotensiBencanaBanjirInaRISKBNPB_3.setVisible(true);lyr_PotensiBencanaGempaBumiInaRISKBNPB_4.setVisible(true);lyr_PotensiBencanaLongsorInaRISKBNPB_5.setVisible(true);lyr_KejadianBencana_6.setVisible(true);
var layersList = [lyr_GoogleHybrid_0,lyr_52KawasanTransmigrasiPronas_1,lyr_JenisTanahFAO_2,lyr_PotensiBencanaBanjirInaRISKBNPB_3,lyr_PotensiBencanaGempaBumiInaRISKBNPB_4,lyr_PotensiBencanaLongsorInaRISKBNPB_5,lyr_KejadianBencana_6];
lyr_52KawasanTransmigrasiPronas_1.set('fieldAliases', {'Kawasan': 'Kawasan', 'PROVINSI': 'PROVINSI', 'KEPMEN': 'KEPMEN', 'LUAS_HA': 'LUAS_HA', 'JUMLAH_KK': 'JUMLAH_KK', });
...
lyr_52KawasanTransmigrasiPronas_1.set('fieldImages', {'Kawasan': 'TextEdit', 'PROVINSI': 'TextEdit', 'KEPMEN': 'TextEdit', 'LUAS_HA': 'TextEdit', 'JUMLAH_KK': '', });
...
lyr_52KawasanTransmigrasiPronas_1.set('fieldLabels', {'Kawasan': 'inline label', 'PROVINSI': 'inline label', 'KEPMEN': 'inline label', 'LUAS_HA': 'inline label', 'JUMLAH_KK': 'inline label', });
lyr_JenisTanahFAO_2.set('fieldLabels', {'Jenis_Soil': 'inline label', 'Keterangan': 'inline label', 'Penjelasan': 'inline label', });
lyr_PotensiBencanaBanjirInaRISKBNPB_3.set('fieldLabels', {'OBJECTID_1': 'no label', 'OBJECTID': 'no label', 'Id': 'header label', 'gridcode': 'no label', 'Shape_Leng': 'no label', 'Shape_Le_1': 'no label', 'Shape_Area': 'no label', });
